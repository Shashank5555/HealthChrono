...
import 'appointments_copy2_model.dart';
export 'appointments_copy2_model.dart';

class AppointmentsCopy2Widget extends StatefulWidget {
  const AppointmentsCopy2Widget({super.key});

  static String routeName = 'AppointmentsCopy2';
  static String routePath = '/appointmentsCopy2';

  @override
  State<AppointmentsCopy2Widget> createState() =>
      _AppointmentsCopy2WidgetState();
}

class _AppointmentsCopy2WidgetState extends State<AppointmentsCopy2Widget>
    with TickerProviderStateMixin {
  late AppointmentsCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentsCopy2Model());
        ...
        floatingActionButton: Padding(
          ...
          child: FutureBuilder<ApiCallResponse>(
            future: FFAppState().userDetails(
              ...
              requestFn: () => HealthChronoAPIsGroup.getUserDetailsCall.call(
            ...
            builder: (context, snapshot) {
              ...
              final floatingActionButtonGetUserDetailsResponse = snapshot.data!;
                  ...
                  context.pushNamed(
                    ...
                    queryParameters: {
                      'userID': serializeParam(
                        HealthChronoAPIsGroup.getUserDetailsCall
                            .userID(
                              floatingActionButtonGetUserDetailsResponse
                                  .jsonBody,
                            )
                            ?.toString(),
                        ParamType.String,
                                            ...
                                            builder: (context) => Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Builder(
                                                    builder: (context) {
                                                      final everythingg = (HealthChronoAPIsGroup
                                                                  .viewAppointmentsForClientCall
                                                                  .everything(
                                                                    listViewViewAppointmentsForClientResponse
                                                                        .jsonBody,

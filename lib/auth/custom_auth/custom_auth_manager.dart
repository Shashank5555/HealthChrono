...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    healthChronoAuthUserSubject.add(
      HealthChronoAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HealthChronoAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HealthChronoAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HealthChronoAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    healthChronoAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
HealthChronoAuthUser? currentUser;

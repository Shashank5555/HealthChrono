...
import '/index.dart';
import 'appointments_copy_widget.dart' show AppointmentsCopyWidget;
import 'package:flutter/material.dart';

class AppointmentsCopyModel extends FlutterFlowModel<AppointmentsCopyWidget> {
  ///  Local state fields for this page.

  List<String> status = ['alloted'];

...
import 'edit_healthmetrics_record_final_model.dart';
export 'edit_healthmetrics_record_final_model.dart';

class EditHealthmetricsRecordFinalWidget extends StatefulWidget {
  const EditHealthmetricsRecordFinalWidget({
    super.key,
  ...
  static String routeName = 'EditHealthmetricsRecordFinal';
  static String routePath = '/editHealthmetricsRecordFinal';

  @override
  State<EditHealthmetricsRecordFinalWidget> createState() =>
      _EditHealthmetricsRecordFinalWidgetState();
}

class _EditHealthmetricsRecordFinalWidgetState
    extends State<EditHealthmetricsRecordFinalWidget> {
  late EditHealthmetricsRecordFinalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditHealthmetricsRecordFinalModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'r8dy8oay' /* Edit your metrics record here */,
                        ),
                                                  ...
                                                  decoration: InputDecoration(
                                                    labelText:
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                      'rlejo9ek' /* Blood Oxygen Level (SpO2) */,
                                                    ),
                                                    labelStyle:
                                                        FlutterFlowTheme.of(
                                                                context)
                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.editMetricsResponse =
                                    ...
                                    height: (double.parse(_model
                                                .heightFeetHMTextController
                                                .text) *
                                            12) +
                                        double.parse(_model
                                            .heightInchesHMTextController.text),
                                  ...
                                  if ((_model.editMetricsResponse?.succeeded ??
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Metrics couldn\'t be edited. Try again...',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:

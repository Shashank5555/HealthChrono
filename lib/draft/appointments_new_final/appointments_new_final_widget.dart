...
import 'appointments_new_final_model.dart';
export 'appointments_new_final_model.dart';

class AppointmentsNewFinalWidget extends StatefulWidget {
  const AppointmentsNewFinalWidget({super.key});

  static String routeName = 'AppointmentsNewFinal';
  static String routePath = '/appointmentsNewFinal';

  @override
  State<AppointmentsNewFinalWidget> createState() =>
      _AppointmentsNewFinalWidgetState();
}

class _AppointmentsNewFinalWidgetState extends State<AppointmentsNewFinalWidget>
    with TickerProviderStateMixin {
  late AppointmentsNewFinalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppointmentsNewFinalModel());
        ...
        floatingActionButton: Padding(
          ...
          child: FutureBuilder<ApiCallResponse>(
            ...
            builder: (context, snapshot) {
              ...
              final floatingActionButtonGetMyProfileClientsMeGetResponse =
                  snapshot.data!;
                  ...
                  context.pushNamed(
                    ...
                    queryParameters: {
                      'userID': serializeParam(
                        NewAPIsGroup.getMyProfileClientsMeGetCall.id(
                          floatingActionButtonGetMyProfileClientsMeGetResponse
                              .jsonBody,
                        ),
                        ParamType.String,
                      ),
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Container(
                                                                                    ...
                                                                                    child: Image.network(
                                                                                      getJsonField(
                                                                                        NewAPIsGroup.searchPractitionersClientsPractitionersSearchGetCall
                                                                                            .everyPrac(
                                                                                              listViewSearchPractitionersClientsPractitionersSearchGetResponse.jsonBody,
                                                                                            )!
                                                                                            .where((e) =>
                                                                                                getJsonField(
                                                                                                  everythingItem,

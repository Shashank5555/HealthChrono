...
import 'practitioner_appointments_model.dart';
export 'practitioner_appointments_model.dart';

class PractitionerAppointmentsWidget extends StatefulWidget {
  const PractitionerAppointmentsWidget({super.key});

  static String routeName = 'PractitionerAppointments';
  static String routePath = '/practitionerAppointments';

  @override
  State<PractitionerAppointmentsWidget> createState() =>
      _PractitionerAppointmentsWidgetState();
}

class _PractitionerAppointmentsWidgetState
    extends State<PractitionerAppointmentsWidget>
    with TickerProviderStateMixin {
  late PractitionerAppointmentsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PractitionerAppointmentsModel());

...
import 'client_health_dashboard_at_p_s_model.dart';
export 'client_health_dashboard_at_p_s_model.dart';

class ClientHealthDashboardAtPSWidget extends StatefulWidget {
  const ClientHealthDashboardAtPSWidget({
    super.key,
    required this.email,
  ...
  static String routeName = 'ClientHealthDashboardAtPS';
  static String routePath = '/clientHealthDashboardAtPS';

  @override
  State<ClientHealthDashboardAtPSWidget> createState() =>
      _ClientHealthDashboardAtPSWidgetState();
}

class _ClientHealthDashboardAtPSWidgetState
    extends State<ClientHealthDashboardAtPSWidget> {
  late ClientHealthDashboardAtPSModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientHealthDashboardAtPSModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'clwndpyu' /* Your daily health metrics at a... */,
                        ),
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '4o1waucs' /* Systolic Blood Pressure */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'dzf41w7l' /* Diastolic Blood Pressure */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'mzzrezlk' /* Waist to Height Ratio */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .headlineSmall

            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    FFLocalizations.of(context).getText(
                      '3gq5rsqt' /* Choose any one reminder of you... */,
                    ),
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  _model.reminderResponse =
                      await HealthChronoAPIsGroup.setUserRemindersCall.call(
                    token: currentAuthenticationToken,
                    appointmentId: widget.appointmentID,
                    reminderMinutesList: () {
                      if (_model.dropDownValue == 'min(s)') {
                        return ((int var1) {
                          return [var1];
                        }(int.parse(_model.textController.text)));
                      } else if (_model.dropDownValue == 'hr(s)') {
                        return ((int var1) {
                          return [var1 * 60];
                        }(int.parse(_model.textController.text)));
                      } else {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '7g44nvun' /* Reminder set successfully... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'mkowekse' /* There was an error. Try again.... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
